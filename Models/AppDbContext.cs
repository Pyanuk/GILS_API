...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<AccountSponsor> AccountSponsors { get; set; }
    ...
    public virtual DbSet<ArtistSocial> ArtistSocials { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AccountSponsor>(entity =>
        {
            entity.HasKey(e => e.IdAccountSponsor).HasName("account_sponsor_pkey");

            entity.ToTable("account_sponsor");

            entity.HasIndex(e => e.Code, "account_sponsor_code_key").IsUnique();

            entity.HasIndex(e => e.Email, "account_sponsor_email_key").IsUnique();

            entity.Property(e => e.IdAccountSponsor).HasColumnName("id_account_sponsor");
        ...
        modelBuilder.Entity<Artist>(entity =>
        {
            ...
            entity.Property(e => e.TypeArtist).HasColumnName("type_artist");
        ...
        {
            entity.HasKey(e => e.Id).HasName("artist_photos_pkey");

            entity.ToTable("artist_photos");
            ...
            entity.HasOne(d => d.Artist).WithMany(p => p.ArtistPhotos)
                .HasForeignKey(d => d.ArtistId)
                .HasConstraintName("fk_artistphotos_artist");
        });

        modelBuilder.Entity<ArtistSocial>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("artist_socials_pkey");

            entity.ToTable("artist_socials");
            ...
            entity.HasOne(d => d.Artist).WithMany(p => p.ArtistSocials)
                .HasForeignKey(d => d.Artistid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("artist_socials_artistid_fkey");
        });
        ...
        {
            entity.HasKey(e => e.IdFavorite).HasName("favorite_tracks_pkey");
            ...
            entity.HasOne(d => d.Track).WithMany(p => p.FavoriteTracks)
        ...
        modelBuilder.Entity<RecentlyPlayed>(entity =>
        {
            ...
            entity.Property(e => e.RecentlyId).HasColumnName("recently_id");
            entity.Property(e => e.TrackId).HasColumnName("track_id");
            entity.Property(e => e.UserId).HasColumnName("user_id");

            entity.HasOne(d => d.Track).WithMany(p => p.RecentlyPlayeds)
                .HasForeignKey(d => d.TrackId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("recently_played_track_id_fkey");

            entity.HasOne(d => d.User).WithMany(p => p.RecentlyPlayeds)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
